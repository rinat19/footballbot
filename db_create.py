...
cur = conn.cursor()
cur.execute('CREATE TABLE footballer (user_id INTEGER PRIMARY KEY, first_name VARCHAR(30), second_name VARCHAR(30), username VARCHAR(30), visit BOOLEAN, resp_date DATE, resp_time TIME WITHOUT TIMEZONE)')
cur.commit()
