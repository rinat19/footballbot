...
def db_insert(from_id, name):
    ...
    values = {'user_id': 'from_id', 'first_name': 'name', 'second_name': None, 'username': None, 'visit': None, 'resp_date': None}
    conn.execute("INSERT INTO footballer (user_id, first_name, second_name, username, visit, resp_date) VALUES (:user_id, :first_name, :second_name, :username, :visit, :resp_date)", (values))
    conn.commit()
